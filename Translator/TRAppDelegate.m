...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
	...
	// Maakt even wat standaard talen aan... Had ook gewoon de sqlite erbij kunnen doen maar vond dit creatiever... :-D
	TRLanguagesModel *languagesModel = [[TRLanguagesModel alloc] init];
	[languagesModel firstStartup];
